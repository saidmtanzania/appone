		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" action="register">
					...
					<div class="wrap-input100 validate-input" data-validate = "middlename is required">
					...
					<div class="wrap-input100 validate-input" data-validate = "regnumber is required">
						<input class="input100" type="text" name="regnumber" placeholder="Registration">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
...
<!--===============================================================================================-->
	...
	<script >
		...
		if(status == "success"){
			...
			swal("Ooops!","Account Created failed","error");
		}
	</script>
<!--===============================================================================================-->
